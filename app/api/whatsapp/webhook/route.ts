...
export async function POST(req: NextRequest) {
  try {
    ...
    // 3. Sender filter: Only process commands for the authorized user's phone
    ...
    // 4. STRICT COMMAND ROUTING: Only respond if text matches a recognized command!
    if (normalizedCmd.startsWith('SAVE')) {
      ...
      // Normal conversation / casual chat -> SILENTLY IGNORE (never reply)
