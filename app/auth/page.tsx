  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-6">
      <div className="w-full max-w-md bg-card border border-border rounded-2xl p-8 shadow-2xl">
        ...
        {/* Feature badge */}
        <div className="mt-8 pt-6 border-t border-border/60 flex items-center justify-center gap-2 text-[11px] text-muted">
          <Sparkles className="w-3.5 h-3.5 text-accent" />
          <span>Automated WhatsApp Deadlines & Daily Digest</span>
        </div>
      </div>
    </div>
  );
